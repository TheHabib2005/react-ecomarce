        ...
        <header className='py-3'>
            <div className='flex items-center justify-between '>
                ...
                <div className=' w-1/3  mx-auto flex items-center '>
                    <Link to={"/"} className=''>
                        <img src="/myshopbd-light.png" alt="" className='md:w-[200px] w-full' />
                    </Link>
                ...
                <div className=' md:w-1/3 flex-1 flex items-center gap-x-6 justify-end'>
                    {/* //user icon */}
                    <SignedOut>
                        <Link to={""} className='w-11 h-11 bg-gray-100 md:flex hidden items-center justify-center rounded-full dark:bg-zinc-900 dark:text-white' >
                    ...
                    {/* wishlist icon */}
                    <Link to={"/profile/wishlist"} className='w-11 h-11 md:flex bg-gray-100 hidden items-center justify-center rounded-full dark:bg-zinc-900 dark:text-white cursor-pointer' >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
